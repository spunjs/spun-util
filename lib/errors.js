...
module.exports = {
  ...
  parsing: {
    ...
    IncludeWithoutArgsError: function IncludeWithoutArgsError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn include without a path argument was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    InfiniteIncludeError: function InfiniteIncludeError(spec, line){
      var e = Error.call(this,
        f(
    ...
    InvalidIncludePathError: function InvalidIncludePathError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn invalid include path argument was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    MultipleMixinDeclarationsError: function MultipleMixinDeclarationsError(spec){
      var e = Error.call(this,
      f('Multiple mixin declarations were found in %s', spec.path));
      this.stack = e.stack;
      this.message = e.message;
    },
    SelfReferencingIncludeError: function SelfReferencingIncludeError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn include that includes itself was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    UnexpectedCloseInMixinError: function UnexpectedCloseInMixinError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn unexpected close command was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    UnexpectedMixinDeclarationError: function UnexpectedMixinDeclarationError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn unexpected mixin declaraion was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    UnexpectedQuitInMixinError: function UnexpectedQuitInMixinError(spec, line){
      var e = Error.call(this,
      f('Spec: %s\nLine: %s\nAn unexpected quit command was found.', spec.path, line.number));
      this.stack = e.stack;
      this.message = e.message;
    },
    UnresolveableIncludeError: function UnresolveableIncludeError(spec, line){
      var e = Error.call(this,
        f(
